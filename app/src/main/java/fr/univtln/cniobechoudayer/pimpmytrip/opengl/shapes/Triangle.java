package fr.univtln.cniobechoudayer.pimpmytrip.opengl.shapes;
...
import fr.univtln.cniobechoudayer.pimpmytrip.opengl.OpenGLRenderer;
...
public class Triangle {
    ...
    float color[] = { 0.20671875f, 0.24953125f, 0.22265625f, 1.0f };
