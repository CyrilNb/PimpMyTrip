...
public class TripsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Trip trip = new Trip("#7F7FD7", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        Trip trip2 = new Trip("#CE48D5", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        Trip trip3 = new Trip("#7F7FD7", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        Trip trip4 = new Trip("#CE48D5", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        Trip trip5 = new Trip("#7F7FD7", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        Trip trip6 = new Trip("#CE48D5", Calendar.getInstance().getTime(), "Mon super trip", true, null, null, null);
        tripsList.add(trip);
        tripsList.add(trip2);
        tripsList.add(trip3);
        tripsList.add(trip4);
