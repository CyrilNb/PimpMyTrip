...
public class User {
    ...
    /**
     * Get the bitmap from encoded 64 based string
     * @return
     */
    @Exclude
    public Bitmap convertedPhoto(){
        byte[] decodedString;
        if(!this.getPhoto().equals(null)){
            decodedString= Base64.decode(this.photo, Base64.DEFAULT);
        }else{
            //default icon
            decodedString = Base64.decode("", Base64.DEFAULT);
        }
        System.out.println("TEST CONVERTED PHOTO");
