...
public class CreateTripTest {
    @Test
    public void tripCreation_isCorrect() throws Exception{
        ...
        Trip checkTrip = TripController.getInstance().createTrip("id1",false,positionList,waypointList,"#000000","trip test",1000,"idCreator");
